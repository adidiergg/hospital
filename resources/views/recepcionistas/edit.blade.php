...
@section('titulo','Administrador | Editar información del recepcionista')
    ...
    <div class="row g-5 mt-5" style="background-color: #D6DBDF;">
        ...
        <div class="col-md-5 col-lg-4 order-1">
            ...
            <form class="needs-validation" novalidate name="altarecepcionista" method="post"
                action="{{ route('receptionists.reset',$receptionist)  }}">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <!-- Contraseña -->
        ...
        <div class="col-md-7 col-lg-8 order-0">
            ...
            <form class="needs-validation" novalidate name="altarecepcionista" method="post"
                action="{{ route('receptionists.update',$receptionist) }}">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <!-- CURP -->
                    ...
                    <div class="col-md-4">
                        ...
                        <input value="{{ $receptionist->curp }}" type="text" style="text-transform: uppercase;"
                            name="curp" minlenght="18" maxlength="18" class="form-control" id="curp" placeholder=""
                    ...
                    <div class="col-md-4">
                        ...
                        <input value="{{ $receptionist->birth_date }}" type="date" name="birth_date"
                            id="fechaContratacion" class="form-control" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input value="{{ $receptionist->phone_number }}" type="tel" class="form-control"
                                id="telefono" name="phone_number" placeholder="" required>
                        </div>
                        <div class="invalid-feedback">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ $receptionist->hire_date }}" type="date" name="hire_date"
                            id="fechaContratacion" class="form-control" required>
                    </div>
                </div>
                <hr class="my-4">
